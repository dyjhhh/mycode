cmd_drivers/base/power/shutdown.o := gcc -m32 -Wp,-MD,drivers/base/power/.shutdown.o.d  -nostdinc -isystem /usr/lib/gcc/i386-redhat-linux/4.1.2/include -D__KERNEL__ -Iinclude -Iinclude2 -I/workdir/source/linux-2.6.22.5/include -include include/linux/autoconf.h -I/workdir/source/linux-2.6.22.5/drivers/base/power -Idrivers/base/power -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O0 -pipe -msoft-float -mregparm=3 -freg-struct-return -mpreferred-stack-boundary=2 -march=i686 -mtune=pentium2 -mtune=generic -ffreestanding -maccumulate-outgoing-args -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -I/workdir/source/linux-2.6.22.5/include/asm-i386/mach-default -Iinclude/asm-i386/mach-default -fomit-frame-pointer -g -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign  -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(shutdown)"  -D"KBUILD_MODNAME=KBUILD_STR(shutdown)" -c -o drivers/base/power/.tmp_shutdown.o /workdir/source/linux-2.6.22.5/drivers/base/power/shutdown.c

deps_drivers/base/power/shutdown.o := \
  /workdir/source/linux-2.6.22.5/drivers/base/power/shutdown.c \
  ...
  /workdir/source/linux-2.6.22.5/drivers/base/power/../base.h \
    $(wildcard include/config/sys/hypervisor.h) \
  /workdir/source/linux-2.6.22.5/drivers/base/power/power.h \
