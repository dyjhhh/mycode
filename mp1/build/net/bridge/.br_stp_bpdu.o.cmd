cmd_net/bridge/br_stp_bpdu.o := gcc -m32 -Wp,-MD,net/bridge/.br_stp_bpdu.o.d  -nostdinc -isystem /usr/lib/gcc/i386-redhat-linux/4.1.2/include -D__KERNEL__ -Iinclude -Iinclude2 -I/workdir/source/linux-2.6.22.5/include -include include/linux/autoconf.h -I/workdir/source/linux-2.6.22.5/net/bridge -Inet/bridge -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O0 -pipe -msoft-float -mregparm=3 -freg-struct-return -mpreferred-stack-boundary=2 -march=i686 -mtune=pentium2 -mtune=generic -ffreestanding -maccumulate-outgoing-args -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -I/workdir/source/linux-2.6.22.5/include/asm-i386/mach-default -Iinclude/asm-i386/mach-default -fomit-frame-pointer -g -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(br_stp_bpdu)"  -D"KBUILD_MODNAME=KBUILD_STR(bridge)" -c -o net/bridge/.tmp_br_stp_bpdu.o /workdir/source/linux-2.6.22.5/net/bridge/br_stp_bpdu.c

deps_net/bridge/br_stp_bpdu.o := \
  /workdir/source/linux-2.6.22.5/net/bridge/br_stp_bpdu.c \
  ...
  /workdir/source/linux-2.6.22.5/include/linux/llc.h \
  /workdir/source/linux-2.6.22.5/include/net/llc.h \
  /workdir/source/linux-2.6.22.5/include/net/llc_pdu.h \
  /workdir/source/linux-2.6.22.5/include/linux/if_tr.h \
  include2/asm/unaligned.h \
  /workdir/source/linux-2.6.22.5/net/bridge/br_private.h \
  /workdir/source/linux-2.6.22.5/include/linux/if_bridge.h \
  /workdir/source/linux-2.6.22.5/net/bridge/br_private_stp.h \
