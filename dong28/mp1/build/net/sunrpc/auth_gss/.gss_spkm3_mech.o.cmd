cmd_net/sunrpc/auth_gss/gss_spkm3_mech.o := gcc -m32 -Wp,-MD,net/sunrpc/auth_gss/.gss_spkm3_mech.o.d  -nostdinc -isystem /usr/lib/gcc/i386-redhat-linux/4.1.2/include -D__KERNEL__ -Iinclude -Iinclude2 -I/workdir/source/linux-2.6.22.5/include -include include/linux/autoconf.h -I/workdir/source/linux-2.6.22.5/net/sunrpc/auth_gss -Inet/sunrpc/auth_gss -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O0 -pipe -msoft-float -mregparm=3 -freg-struct-return -mpreferred-stack-boundary=2 -march=i686 -mtune=pentium2 -mtune=generic -ffreestanding -maccumulate-outgoing-args -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -I/workdir/source/linux-2.6.22.5/include/asm-i386/mach-default -Iinclude/asm-i386/mach-default -fomit-frame-pointer -g -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(gss_spkm3_mech)"  -D"KBUILD_MODNAME=KBUILD_STR(rpcsec_gss_spkm3)" -c -o net/sunrpc/auth_gss/.tmp_gss_spkm3_mech.o /workdir/source/linux-2.6.22.5/net/sunrpc/auth_gss/gss_spkm3_mech.c

deps_net/sunrpc/auth_gss/gss_spkm3_mech.o := \
  /workdir/source/linux-2.6.22.5/net/sunrpc/auth_gss/gss_spkm3_mech.c \
  ...
  /workdir/source/linux-2.6.22.5/include/linux/sunrpc/svcauth_gss.h \
  ...
  /workdir/source/linux-2.6.22.5/include/linux/sunrpc/auth_gss.h \
  /workdir/source/linux-2.6.22.5/include/linux/sunrpc/gss_api.h \
  /workdir/source/linux-2.6.22.5/include/linux/sunrpc/gss_spkm3.h \
  /workdir/source/linux-2.6.22.5/include/linux/sunrpc/gss_err.h \
  /workdir/source/linux-2.6.22.5/include/linux/sunrpc/gss_asn1.h \
